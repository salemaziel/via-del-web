module.exports = {
    ...
    title: 'Via Del Web Website Design+Development & Digital Marketing', // Navigation and Site Title
    titleAlt: 'Via Del Web Website Design & Digital Marketing', // Title for JSONLD
    ...
    shortName: 'Via Del Web', // shortname for manifest. MUST be shorter than 12 characters
    ...
    manifestName: "Via Del Web Website Design & Digital Marketing",
    ...
    socialLinks: [
      {
        icon: 'fa-instagram',
        name: 'Instagram',
        url: 'https://instagram.com/viadelweb',
      },
      {
        icon: 'fa-facebook',
        name: 'Facebook',
        url: 'https://facebook.com/viadelweb',
      },
      {
        icon: 'fa-twitter',
        name: 'Twitter',
      ...
      },
      {
        icon: 'fa-linkedin',
        name: 'LinkedIn',
        url: 'https://linkedin.com/viadelweb',
      },
      {
        icon: 'fa-envelope-o',
        name: 'Email',
        url: 'mailto:contact@viadelweb.com',
      },
    ],
  };