    ...
    <Row className="justify-content-center justify-center">
      {props.items.map((item, index) => (
        <Col
          ...
          md={6}
          lg={4}
          className="py-3 d-flex align-items-stretch items-stretch flex"
          key={index}
        >
          ...
          <Card style={{borderColor: '#217ebd'}} >
            ...
            <Card.Body className="d-flex flex-column text-center align-items-center items-center p-4 flex flex-col ">
            <div className="Cards__avatar-wrapper">
                <Image src={item.iconImage} alt={item.stepTitle} height="128px" />
              </div>
              <h6 className="font-weight-bold mb-2 mt-3 font-bold">{item.stepNumber}</h6>
              <p style={{fontSize: '1.5rem', color: '#217ebd'}} className="font-weight-bold font-bold">{item.stepTitle}</p>
